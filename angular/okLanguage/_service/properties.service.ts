...
export class PropertiesService {
    ...
    public port = environment.hostname;
    ...
    public passwordPattern = "^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[^\w\s]).{6,}$";
    ...
    public defaultFieldPasswordMessage = "É necessário uma letra maiúscula, uma mínuscula e um número, caracteres especiais são opcionais."
    public defaultPatterAndSpecialCharactersMessage = "São permitidos somente números, letras, caracteres especiais e espaços"
    public defaultFieldRequiredMessage = "Preencha o campo corretamente.";
    public defaultFieldMinLengthMessage = "A quantidade mínima de caracteres é de ";
    public defaultFieldMaxLengthMessage = "A quantidade máxima de caracteres é de ";
    public defaultOnlyNumberMessage = "É permitido somente números."
    public defaultOnlyStringMessage = "É permitido somente letras."
    public defaultPatternMessage = "São permitidos somente números, letras e espaços";
